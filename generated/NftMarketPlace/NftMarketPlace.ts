...
export class WithdrawProccedsCall extends ethereum.Call {
  get inputs(): WithdrawProccedsCall__Inputs {
    return new WithdrawProccedsCall__Inputs(this);
  }

  get outputs(): WithdrawProccedsCall__Outputs {
    return new WithdrawProccedsCall__Outputs(this);
  }
}

export class WithdrawProccedsCall__Inputs {
  _call: WithdrawProccedsCall;

  constructor(call: WithdrawProccedsCall) {
    this._call = call;
  }
}

export class WithdrawProccedsCall__Outputs {
  _call: WithdrawProccedsCall;
